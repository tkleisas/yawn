...
std::vector<int64_t> TransientDetector::detect(const AudioBuffer& buffer) {
    return detect(buffer, Config());
}

std::vector<int64_t> TransientDetector::detect(const AudioBuffer& buffer, const Config& config) {
...
double TransientDetector::estimateBPM(const std::vector<int64_t>& transients,
                       double sampleRate,
                       double minBPM,
                       double maxBPM) {
