...
public:
    ...
    void paint(UIContext& ctx) override {
        ...
        textY += lineH + 4;
        font->drawText(*renderer, "Yet Another Audio Workstation New", textX, textY,
        ...
        textY += lineH;
        font->drawText(*renderer, "PM: Tasos Kleisas", textX, textY,
                        tsSmall, Theme::textSecondary);
        textY += lineH;
        font->drawText(*renderer, "Chief Engineer: Claude (Anthropic)", textX, textY,
                        tsSmall, Theme::textSecondary);
