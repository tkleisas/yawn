...
// Progress callback. Return true to continue, false to cancel — the
// segment loop in demucs_inference checks the return and bails early
// (returning an empty tensor), which yawn wires to a Cancel button.
